...
def dynamic_import(module, name, attrs=None):
    """
    import by name
    """
...
def create_pipeline(json_file_path):
    ...
    for transform_desc in json_data["transforms"]:
        ...
        try:
            transform = dynamic_import(import_prefix, transform_name)
        except ValueError:
    ...
    return dynamic_import(import_prefix, json_data["pipeline_composer"])(transforms)
