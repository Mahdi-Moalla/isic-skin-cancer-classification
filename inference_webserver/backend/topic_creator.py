...
if __name__ == '__main__':
    ...
    kafka_topic_num_partitions = int(os.getenv('kafka_topic_num_partitions', "1"))
    kafka_topic_replication_factor = int(os.getenv('kafka_topic_replication_factor', "1"))

    admin_client = KafkaAdminClient(bootstrap_servers=kafka_server, client_id='isic_topic_creator')
